          ...
          Padding(
            ...
            child: Container(
              ...
              decoration: const BoxDecoration(
                color: AppColor.grey,
                borderRadius: BorderRadius.only(bottomLeft: Radius.circular(60),bottomRight: Radius.circular(20))
              ),
              child:ProfileCard(),
            ),
          ),
               ...
               [
                ...
                child:Container(
                  ...
                  child:Column(
                    children: [
                      SizedBox(height:50),
                      Text("Ayah Shraim",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 25),),
                      SizedBox(height:5),
                      Text("(22 year),Palestine",style: TextStyle(fontSize: 10)),
                      SizedBox(height:20),
                      ProfileTop(),
                    ],
                  )
