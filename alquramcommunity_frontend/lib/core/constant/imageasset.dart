class AppImageAsset {
  ...
  static const String profile = "$rootImages/user-128.png";
  ...
  static const String notfication = "$rootImages/mosqueLine.png";

  static const String childImage = "$rootImages/childImage.png";
}
