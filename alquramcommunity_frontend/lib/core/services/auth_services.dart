...
class AuthServices { 
  ...
  String uri2 = 'http://192.168.1.18:8080'; 
...
void signUpUser({ 
  ...
  try { 
    ...
    if (response.statusCode == 200) { 
      // Handle success case 
      showSnackBar( 
          context, 'Account created successfully, login with same information'); 
 ...
 updateUser({ 
  ...
  try{ 
   ...
   if (response.statusCode == 200) { 
    ...
    profilesController.userAge.value=userProfile['user']['userAge'].toString(); 
